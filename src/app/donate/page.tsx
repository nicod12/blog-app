...
export default function DonatePage() {
    return(
        <section className="flex flex-col items-center mt-20 ">
            <h2 className="text-orange-400 text-[22px] lg:text-[25px] xl:text-[26px] 2xl:text-[30px] animate__animated animate__backInUp animate__delay-1s">Donations</h2>
            <p className="py-4 lg:py-8 px-8 text-center text-gray-300 text-[16px] lg:text-[18px] xl:text-[20px] 2xl:text-[22px] animate__animated animate__backInUp animate__delay-2s">Lorem ipsum dolor sit amet consectetur adipisicing elit. Tempore, incidunt inventore ullam voluptatibus laboriosam illum voluptates similique. Commodi repellat quasi error atque nobis, similique obcaecati cum temporibus, minima pariatur aspernatur?
            ...
            <div className="mt-4 animate__animated animate__backInUp animate__delay-3s">
                ...
                <li>
                    <Link href="https://www.mercadopago.com.ar/" className="text-[70px]">
                        <div className="flex flex-col items-center overflow-hidden transition-transform transform hover:scale-110">
                            <SiMercadopago />
