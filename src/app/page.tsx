    ...
    <main className="flex flex-col justify-center items-center">  
      <section className=" flex  flex-col lg:flex-row xl:flex-row 2xl:flex-row lg:gap-5 xl:gap-5 2xl:gap-8 justify-center items-center mt-10 lg:mt-14 xl:mt-14 2xl:mt-14">
       <div className="m-2 p-0 lg:p-12 xl:p-12 2xl:p-4">
        ...
        <h3 className="text-[15px] lg:text-[22px] xl:text-[22px] 2xl:text-[26px]  mt-6 text-gray-200 shadow-sm uppercase">A great place to <span className="text-orange-400 border-b-2 py-1 border-orange-400">walk your pets</span></h3>

        <div className="mt-10 flex gap-4 items-center w-auto">
          <Button 
            className="border-2 border-[#242321] shadow-md lg:shadow-md xl:shadow-lg 2xl:shadow-lg px-6 lg:px-10 xl:px-10 2xl:px-12 py-3 lg:py-4 xl:py-4 2xl:py-4 rounded-full text-sm lg:text-lg xl:text-lg 2xl:text-xl text-white font-bold uppercase" 
            value="Location"
          />

          <Button  
            className="border-2 border-[#242321] shadow-md lg:shadow-md xl:shadow-lg 2xl:shadow-lg  px-6 lg:px-10 xl:px-10 2xl:px-12 py-3 lg:py-4 xl:py-4 2xl:py-4  rounded-full  text-sm lg:text-lg xl:text-lg 2xl:text-xl flex items-center gap-x-2 lg:gap-x-4 xl:gap-x-4 2xl:gap-x-4 text-white font-bold bg-[#201f1d] uppercase" 
            value="Hours">
              <Image 
       ...
       <Image
        ...
        height={200}
        width={300}
        className="px-2 w-48 lg:w-[300px] xl:w-[300px] 2xl:w-[340px]"
        loading="eager"
      />
       </div>
      </section>
      ...
      <section className="p-14 mt-6 relative">
        ...
        <div className="absolute bottom-0 p-2 left-0 right-0 text-center">
          <h2 className="mx-auto text-[15px] lg:text-[18px] xl:text-[18px] 2xl:text-[24px] font-bold xl:mt-4 2xl:mt-6">Daysy Knigth Dog Park</h2>
