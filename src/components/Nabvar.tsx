...
const Navbar = () => {
  ...
  const content = (
    <section 
      className={`lg:hidden block  h-screen absolute top-0 w-full left-0 right-0 bg-[#181715] transform transition-all duration-500 ${open ? 'translate-x-0' : '-translate-x-full z-50  fixed'}`}
    >
