...
const Navbar = () => {
  ...
  const content = (
    <section 
    className={`lg:hidden block h-screen absolute top-0 w-full left-0 right-0 ${open ? 'bg-[#181715] transform translate-x-0 z-100 fixed' : 'transform -translate-x-full z-100 fixed'}`}
    >
